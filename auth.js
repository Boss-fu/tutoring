...
function showGate(message = '') {
  ...
  const parentNotice = isParentPage ? '<p class="notice">首次登入請使用教師提供的預設密碼 <b>00000000</b>。登入後系統會請您立即設定自己的新密碼。</p><a class="auth-guide-link" href="/parent-guide">📖 家長端使用說明</a>' : '';
